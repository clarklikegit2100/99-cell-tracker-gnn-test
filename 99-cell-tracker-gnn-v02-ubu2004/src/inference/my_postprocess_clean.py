...
if __name__== "__main__":
    ...
    data_path='/home/tony/data/gnntest/CTC'
    dataset_name='Fluo-C2DL-Huh7'
    path_inference_output = f'{data_path}/{dataset_name}/01_RES_inference'
    #path_Seg_result = args.iseg
    path_Seg_result =  f'{data_path}/{dataset_name}/01_Msk_CSTQ'
    ...
    pp.save_csv(df_trajectory, 'all_frames_traject.csv')
