...
MIN_SIZE="900"
SIZES="900 1000000"
DATASET="${PWD}/../PhC-C2DH-U373"
CODE_SEG="${PWD}/seg_code/new_version"
CODE_TRA="${PWD}"
SEG_MODEL="${PWD}/parameters/Seg_Models/PhC-C2DH-U373/"
MODEL_METRIC_LEARNING="${PWD}/parameters/Features_Models/PhC-C2DH-U373/all_params.pth"
MODEL_PYTORCH_LIGHTNING="${PWD}/parameters/Tracking_Models/PhC-C2DH-U373/checkpoints/epoch=10.ckpt"
MODALITY="2D"
        
# seg prediction
python ${CODE_SEG}/Inference2D.py --gpu_id 0 --model_path ${SEG_MODEL} --sequence_path "${DATASET}/${SEQUENCE}" --output_path "${DATASET}/${SEQUENCE}_SEG_RES" --edge_dist 1 --edge_thresh 0.3 --min_cell_size 900 --max_cell_size 100000 --fov 50 --centers_sigmoid_threshold 1 --min_center_size 10 --pre_sequence_frames 4 --data_format NCHW --save_intermediate --save_intermediate_path ${DATASET}/${SEQUENCE}_SEG_intermediate
